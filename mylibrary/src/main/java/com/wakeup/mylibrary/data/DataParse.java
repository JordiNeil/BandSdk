...
public class DataParse {
    ...
    private  HourlyMeasureDataBean hourlyMeasureDataBean;
    ...
    public Object parseData(List<Integer> datas) {
        ...
        if (datas.get(0) == 0xAB) {
            ...
            switch (datas.get(4)) {
                ...
                case 0x92:
                    ...
                    if (datas.size() > 16) {
                        ...
                        if (datas.size() > 17) {
                            ...
                            bandInfo.setHasInstagram(((type1 >> 0) & 0x01) == 1);
                            bandInfo.setHasJiuzuotixing(((type1 >> 0) & 0x01) == 1);
                            bandInfo.setHeartRateSaveBattery(((type1 >> 0) & 0x01) == 1);
                            bandInfo.setHeartRateHongwai(((type1 >> 0) & 0x01) == 1);
                            bandInfo.setMoreMessage(((type1 >> 0) & 0x01) == 1);
                        }
                    }
                ...
                case 0x51:
                    ...
                    if (Config.hasContinuousHeart) {
                        //如果是连续心率手环
                        object = parse51Data(datas, object, timeInMillis);
            ...
            //整点测量数据第二个包
            Log.i(TAG, "整点测量数据第二个包");


            int shallowSleep = datas.get(1) * 60 + datas.get(2);
            int deepSleep = datas.get(3) * 60 +datas.get(4);
            int wakeupTimes = datas.get(5);
     ...
     * @return
     */
    private Object parse51Data(List<Integer> datas, Object object, long timeInMillis) {
        if (datas.get(5) == 0x11) {
            //单机测量 连续心率数据
            ...
            this.hourlyMeasureDataBean = hourlyMeasureDataBean;
            object = hourlyMeasureDataBean;
